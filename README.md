...
Input: 1×28×28 Conv2d(1→32) + ReLU + MaxPool → 32×14×14 Conv2d(32→64) + ReLU + MaxPool → 64×7×7 Conv2d(64→128) + ReLU →
128×7×7 Flatten Linear(6272→256) + ReLU + Dropout(0.5)   Linear(256→26) Output: 26 классов
...
Ответ:
json {   "status": "ok",   "device": "cpu",   "classes": ["A", "B", "...", "Z"],   "model_path": "
model/letter_cnn.pth" }
...
json {   "predicted_letter": "A",   "predicted_index": 0,   "confidence": 0.9821,   "probabilities": { "A": 0.9821, "B":
0.003 } }
